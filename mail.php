...
if(!$mail->send()) {
   ...
   header('location: https://solutions4ad.com/partner/scripts/l2d1sz5?AccountId=2361fbf0&TotalCost=0&OrderID= ' .$phone. ' &ActionCode=Humanit_CPS&CampaignID=e95d00cb; Refresh: 5; url=https://www.ecommerce.humanit.group/thanku.html');
}
?>
